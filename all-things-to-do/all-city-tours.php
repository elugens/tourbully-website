...
$tourselect = "SELECT DISTINCT Cityname, city, Region, Country FROM vapproducts ORDER by Cityname ASC";
...
<title>All City Sightseeing Tours &amp; Attractions  - <?php echo ucfirst($_GET['letter']); ?></title>
<meta name="keywords" content="sightseeing,tours,attractions,things to do,activities"/>
<meta name="description" content="Search for city sightseeing tours, attractions, activities, things to do and much more in cities world wide. We have the top tours available while you are on vacation."/>
<meta content="INDEX,FOLLOW" name="ROBOTS"/>
<meta content="15 days" name="revisit-after"/>
<meta name="rating" content="General"/>
<link rel="icon" type="image/png"  href="../images/favicon.png">
<link rel="canonical" href="http://www.tourbully.com/all-things-to-do/all-city-tours.php"/>
...
<!-- End Viator Partner Widget -->
				...
				<div id="maincontent">											
					<h1 style="text-align:center">All Cities - Guided Tours, Attractions, 
					Activities, &amp; Things to Do</h1>
					<div id="pagination">
					...
					<ul>
					<?php do {?>
					<li><a href="sightseeing-tours.php?city=<?php echo $tourInfo['city'];?>"><?php echo $tourInfo['Cityname'];?> / <?php echo $tourInfo['Region'];?> / <?php echo $tourInfo['Country'];?></a></li>
