...
// make cities the current db
	...
	$tourselect = "SELECT DISTINCT Cityname, city FROM vapproducts WHERE Cityname LIKE '$letter%' ORDER by Cityname ASC";
...
<title>Sightseeing Tours, Attractions, &amp; Things to Do by City - Letter <?php echo ucfirst($_GET['letter']); ?></title>
<meta name="keywords" content="sightseeing,tours,attractions,things to do,activities"/>
<meta name="description" content="Find information about Sightseeing Tours, Attractions, & Things to Do in our tourism guide. We have over 9,000 landmark tours available in over 100 countries world wide."/>
<meta content="INDEX,FOLLOW" name="ROBOTS"/>
<meta content="15 days" name="revisit-after"/>
<meta name="rating" content="General"/>
<link rel="icon" type="image/png"  href="../images/favicon.png">
<link rel="canonical" href="http://www.tourbully.com/all-things-to-do/tour-cities.php?letter=<?php echo lcfirst($_GET['letter']); ?>"/>
...
<!-- End Viator Partner Widget -->
				...
				<div id="maincontent">											
					<h1 style="text-align:center">Sightseeing Tours, 
					Attractions, &amp; Things to Do by City - Letter <?php echo ucfirst($_GET['letter']); ?></h1>
					<div id="pagination">
						<a href="all-city-tours.php">City Tours</a> 
						Alphabetical Listing - 
						<a href="tour-cities.php?letter=a" title="A">A</a>
						<a href="tour-cities.php?letter=b" title="B">B</a>
						<a href="tour-cities.php?letter=c" title="C">C</a>
						<a href="tour-cities.php?letter=d" title="D">D</a>
						<a href="tour-cities.php?letter=e" title="E">E</a>
						<a href="tour-cities.php?letter=f" title="F">F</a>
						<a href="tour-cities.php?letter=g" title="G">G</a>
						<a href="tour-cities.php?letter=h" title="H">H</a>
						<a href="tour-cities.php?letter=i" title="I">I</a>
						<a href="tour-cities.php?letter=j" title="J">J</a>
						<a href="tour-cities.php?letter=k" title="K">K</a>
						<a href="tour-cities.php?letter=l" title="L">L</a>
						<a href="tour-cities.php?letter=m" title="M">M</a>
						<a href="tour-cities.php?letter=n" title="N">N</a>
						<a href="tour-cities.php?letter=o" title="O">O</a>
						<a href="tour-cities.php?letter=p" title="P">P</a>
						<a href="tour-cities.php?letter=q" title="Q">Q</a>
						<a href="tour-cities.php?letter=r" title="R">R</a>
						<a href="tour-cities.php?letter=s" title="S">S</a>
						<a href="tour-cities.php?letter=t" title="T">T</a>
						<a href="tour-cities.php?letter=u" title="U">U</a>
						<a href="tour-cities.php?letter=v" title="V">V</a>
						<a href="tour-cities.php?letter=w" title="W">W</a>
						<a href="tour-cities.php?letter=x" title="X">X</a>
						<a href="tour-cities.php?letter=y" title="Y">Y</a>
						<a href="tour-cities.php?letter=z" title="Z">Z</a>
					</div>
					...
					<ul>
					<?php do {?>
					<li><a href="sightseeing-tours.php?city=<?php echo $tourInfo['city'];?>"><?php echo $tourInfo['Cityname'];?> Guided Tours, Attractions &amp; Things to Do</a></li>
