...
$hotelselect = "SELECT DISTINCT city.city_name, city.state_name, city.country_name FROM city WHERE city.country_name LIKE '$country_name' ORDER by state_name ASC";
