...
$hotelselect = "SELECT DISTINCT city.state_name, city.country_name, city.city_name FROM city WHERE city.country_name LIKE '$country_name' ORDER by city_name ASC";
