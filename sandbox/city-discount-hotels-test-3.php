	...
	<div class="clear"></div>
		<div id="content">
			<div id="contentwrapper">
				...
				<div id="maincontent">	
					<div id="hotelheader">				
					<h1>Los Angeles - Discount Hotels, Motels Inns &amp; Resorts</h1>
					</div>
				<div id="leftsideparagraph">
					...
					<div id="hotelresults">
						<p>Total Number of Hotels in Los Angeles, CA: 357</p>
					</div>
				...
				<div id="hotelimages">
				<img alt="" src="../hotels-motels-resorts-inns/<?php echo $hotelInfo['thumbnail'];?>" width="90" height="90">
				</div>
				
				<div id="hotellistingsinfo">
				<h2><?php echo $hotelInfo['hotel_name'];?></h2>
				<div id="hotellistingsaddress">
				<div id="starrating_4">
				<img alt="" src="../images/starrating_<?php echo $hotelInfo['star_rating'];?>.png"><p>&nbsp; - <?php echo $hotelInfo['hotel_address_full'];?>, <?php echo $hotelInfo['city_name'];?>, <?php echo $hotelInfo['state_code'];?></p>
				</div>
				<div id="hoteldescription">
				<p><?php echo (substr($hotelInfo ['property_description'],0,245));?></p>
				</div>
				...
				<div id="hotelinfosale">
					<div id="hotelcheckrate"><p>Check the Current Hotel Rate by Clicking Below</p></div>
					<a href="http://go.farebully.com/hotel/?refid=6084&rs_hid=<?php echo $hotelInfo['hotelid_t'];?>"><input type="submit" name="booknow" class="booknow" value="View Prices" /><a/>
