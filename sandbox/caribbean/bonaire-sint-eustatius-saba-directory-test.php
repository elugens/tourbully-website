...
$hotelselect = "SELECT DISTINCT city.city_name, city.country_name FROM city WHERE city.country_name LIKE 'Bonaire, Sint Eustatius And Saba' ORDER by city_name ASC";
