...
$hotelselect = "SELECT DISTINCT city.city_name, city.hotel_count, city.country_name FROM city WHERE city.country_name AND city.hotel_count>=1 LIKE 'Saint Barthelemy' ORDER by city_name ASC";
