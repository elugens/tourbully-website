...
$hotelselect = "SELECT DISTINCT city.city_name, city.country_name, city.hotel_count FROM city WHERE city.country_name AND city.hotel_count>=1 LIKE 'Saint Martin (French Part)' ORDER by city_name ASC";
