...
$hotelselect = "SELECT city.state_name, city.country_name, city.city_name, city.cityid, hotel.cityid, hotel.hotel_name, hotel.lowrate, hotel.star_rating, hotel.nearbyhotels FROM city JOIN hotel ON city.cityid = hotel.cityid WHERE city.city_name='$city_name' AND city.cityid='$cityid' AND hotel.country_name='$country_name' AND active='1' ORDER by overall_rating DESC LIMIT 0,15";
		...
		<div id="content">
			<div id="contentwrapper">
				...
				<div id="maincontent">
					...
					<ol>
					<?php do {?>
					<li><?php echo $hotelInfo['hotel_name'];?> - $<?php echo $hotelInfo['lowrate'];?> - Star Rating:<?php echo $hotelInfo['star_rating'];?></li>
