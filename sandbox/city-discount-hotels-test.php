			...
			<div id="contentwrapper">
				...
				<div id="maincontent">
					...
					<div id="hotelimages">
						...
						<img alt="" src="../hotels-motels-resorts-inns/<?php echo $hotelInfo['thumbnail'];?>">
						
					</div>
					<div>
					<?php echo $hotelInfo['hotel_name'];?>
					</div>
					<div>
					<?php echo $hotelInfo['star_rating'];?>
					</div>
					<div>
					<?php echo $hotelInfo['hotel_address_full'];?>, <?php echo $hotelInfo['city_name'];?>, <?php echo $hotelInfo['state_name'];?>
					</div>
					<div>
