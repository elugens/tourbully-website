	...
	<div class="clear"></div>
		<div id="content">
			<div id="contentwrapper">
				...
				<p>
				<a href="http://go.farebully.com/city/?refid=6084&amp;rs_cid=<?php echo "$cid"; ?>">View More Hotels in <?php echo "$city"; ?>, <?php echo "$statecode"; ?> <?php echo "$country"; ?> - CLICK HERE</a></p>
				</div>
				...
				<div id="hotelimages">
					<img alt="Discount Rental Car Services in <?php echo "$city"; ?>" height="90" src="../images/camry-rental-car-thumb.png" width="90">
				</div>
				...
				in <?php echo "$city"; ?>, <?php echo "$statecode"; ?> <?php echo "$country"; ?>!  Make reservations in advance by booking now &amp; enjoy the freedom of driving in Dhaka at your own pace. Book with us &amp; Save Up to 40% 
				on rental cars in <?php echo "$city"; ?>.</p>
				</div>
				...
				<div id="hotelinfosale">
					...
					<a href="http://go.farebully.com/car_rentals/home/?refid=6084" target="_blank"><input type="submit" name="booknow" class="booknow" value="Book Now" /><a/>				
				...
				<div id="hotelimages">
					<img alt="<?php echo "$city";?> Sightseeing Tours, Activites &amp; Airport Transfers" height="90" src="../images/new-york-city-hop-on-off-bus-2.png" width="90">
				</div>
				
				<div id="hotellistingsinfo">
				<h2><?php echo "$city";?> City Tours, Activites, &amp; Transfers</h2>
				...
				<div id="hotelinfosale">
					...
					<a href="http://www.partner.viator.com/en/2451/search/<?php echo "$country";?> Tours" target="_blank"><input type="submit" name="booknow" class="booknow" value="Book Now" /><a/>				
				...
				<div id="hoteldescription">
				<p>Find the Lowest Limousine Rates Guaranteed! From Luxury Limo Service to Executive Car Services. Limo Bully has the Best Limo Prices and Discounts for Limousine Service in <?php echo "$city"; ?></p>
				</div>
				...
				<div id="hotelinfosale">
					...
					<a href="http://www.limobully.com" target="_blank" rel="nofollow"><input type="submit" name="booknow" class="booknow" value="Book Now" /><a/>				
