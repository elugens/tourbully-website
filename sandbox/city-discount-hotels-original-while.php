	...
	<div class="clear"></div>
		<div id="content">
			<div id="contentwrapper">
				...
				<div id="starrating_4">
				<img alt="" src="../images/starrating_<?php echo $hotelInfo['star_rating'];?>.png"><p>&nbsp; - <?php echo $hotelInfo['hotel_address_full'];?>, <?php echo $hotelInfo['city_name'];?>, <?php echo $hotelInfo['state_code'];?> <?php echo $hotelInfo['country_name'];?></p>
				</div>
				...
				<p>VIEW MORE HOTELS IN <?php echo $hotelInfo['city_name'];?> - CLICK HERE</p>
				</div>
