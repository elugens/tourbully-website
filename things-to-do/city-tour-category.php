...
$tourselect = "SELECT DISTINCT Group1, category, Cityname, city, Country, Region FROM vapproducts WHERE city='$city' ORDER by Group1 ASC";
...
<title><?php echo $tourInfo['Cityname'];?> - Sightseeing Tours &amp; Attractions by Category - <?php echo $tourInfo['Cityname'];?></title>
<meta name="keywords" content="<?php echo strtolower ($tourInfo['Cityname']);?>,<?php echo strtolower ($tourInfo['Region']);?>,<?php echo strtolower ($tourInfo['Country']);?>,sightseeing,tours,tourist attractions,things to do,activities" />
<meta name="description" content="Find information about <?php echo $tourInfo['Cityname'];?> sightseeing tours, tourist attractions, activities, and things to do in <?php echo $tourInfo['Cityname'];?>, <?php echo $tourInfo['Region'];?>, <?php echo $tourInfo['Country'];?>."/>
<meta content="INDEX,FOLLOW" name="ROBOTS"/>
<meta content="15 days" name="revisit-after"/>
<meta name="rating" content="General"/>
<link rel="icon" type="image/png"  href="../images/favicon.png">
<link rel="canonical" href="http://www.tourbully.com/things-to-do/city-tour-category.php?city=<?php echo $tourInfo['city'];?>"/>
...
<!-- End Viator Partner Widget -->
				...
				<div id="maincontent">											
					<h1 style="text-align:center"><?php echo $tourInfo['Cityname'];?> - Sightseeing Tours &amp; Activities by Category</h1>
					<div id="pagination">
					...
					<ul>
					<?php do {?>
					<li><a href="city-tour.php?city=<?php echo $tourInfo['city'];?>&category=<?php echo $tourInfo['category'];?>"><?php echo $tourInfo['Group1'];?> - <?php echo $tourInfo['Cityname'];?></a></li>
