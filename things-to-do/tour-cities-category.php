...
<title>Sightseeing Tours, Things to Do, &amp; Activities by City - Letter <?php echo ucfirst($_GET['letter']); ?></title>
<meta name="keywords" content="sightseeing,tours,tourist,attractions,things to do,activities"/>
<meta name="description" content="Find information about sightseeing tours, tourist attractions, things to do, activites, cruises, shore excursion and much more."/>
<meta content="INDEX,FOLLOW" name="ROBOTS"/>
<meta content="15 days" name="revisit-after"/>
<meta name="rating" content="General"/>
<link rel="icon" type="image/png"  href="../images/favicon.png">
<link rel="canonical" href="http://www.tourbully.com/things-to-do/tour-cities-category.php?letter=<?php echo lcfirst($_GET['letter']); ?>"/>
...
<!-- End Viator Partner Widget -->
				...
				<div id="maincontent">											
					<h1 style="text-align:center">Sightseeing Tours, Things to 
					Do, &amp; Activities by City - Letter <?php echo ucfirst($_GET['letter']); ?></h1>
					<div id="pagination">
					...
					<ul>
					<?php do {?>
					<li><a href="city-tour-category.php?city=<?php echo $tourInfo['city'];?>"><?php echo $tourInfo['Cityname'];?> Guided Tours, Attractions, &amp; Things to Do</a></li>
