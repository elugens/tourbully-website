...
$tourselect = "SELECT vapproducts.city, vapproducts.ProductName, vapproducts.ProductTextNoDivs, vapproducts.Cityname, vapproducts.Region, vapproducts.Country, vapproducts.ProductImageThumb, vapproducts.Duration, vapproducts.PriceUSD, vapproducts.ProductURL, vapproducts.Group1, vapproducts.category, cities.carurl, cities.hotelurl, cities.cityid, cities.cityurl, cities.countryurl FROM vapproducts RIGHT JOIN cities ON cities.city_name = vapproducts.Cityname WHERE city='$City' AND category='$Category' LIMIT 10";
...
<title><?php echo $tourInfo['Cityname']; ?> <?php echo $tourInfo['Group1']; ?> - <?php echo $tourInfo['Cityname']; ?> Tours</title>
<meta name="keywords" content="<?php echo strtolower($tourInfo['Cityname']); ?>,<?php echo strtolower($tourInfo['Group1']); ?>,tours,sightseeing,attractions,guides,guided,landmarks,<?php echo strtolower($tourInfo['Country']); ?>,<?php echo strtolower($tourInfo['Region']); ?>"/>
<meta name="description" content="Looking for the best prices on <?php echo strtolower($tourInfo['Group1']); ?> tours, attractions and more in <?php echo $tourInfo['Cityname']; ?>, <?php echo $tourInfo['Region']; ?>. Find the best deals on <?php echo strtolower($tourInfo['Group1']); ?> tours in <?php echo $tourInfo['Cityname']; ?>, <?php echo $tourInfo['Region']; ?> <?php echo $tourInfo['Country']; ?>."/>
<meta content="INDEX,FOLLOW" name="ROBOTS"/>
<meta content="15 days" name="revisit-after"/>
<meta name="rating" content="General"/>
<link rel="icon" type="image/png"  href="../images/favicon.png">
<link rel="canonical" href="http://www.tourbully.com/things-to-do/city-tour.php?city=<?php echo $tourInfo['city']; ?>&category=<?php echo $tourInfo['category']; ?>"/>
...
<!-- End Viator Partner Widget -->
				...
				<div id="maincontent">	
					<div id="hotelheader">				
					<h1><?php echo $tourInfo['Cityname'];?> Discount <?php echo $tourInfo['Group1'];?> Online</h1>
					</div>
					
					<div id="hotelresults">
						<p><?php echo $tourInfo['Group1'];?> in <?php echo $tourInfo['Cityname'];?>, <?php echo $tourInfo['Region'];?>, <?php echo $tourInfo['Country'];?></p>
					</div>
				...
				<?php
					...
					do { $i++;
						...
						$overview = (substr($tourInfo ['ProductTextNoDivs'],0,155));
						$city = $tourInfo["Cityname"];
						$vapcityurl = $tourInfo["city"];
				...
				<p>
				<a href="all-things-to-do/sightseeing-tours.php?city=<?php echo "$vapcityurl"; ?>" title="<?php echo "$city"; ?> Hotels">View More Tours in <?php echo "$city"; ?>, <?php echo "$region"; ?> <?php echo "$country"; ?> - CLICK HERE</a></p>
				</div>
				...
				in <?php echo "$city"; ?>, <?php echo "$region"; ?> <?php echo "$country"; ?>
				! Make reservations in advance by booking now &amp; Save Up to 40% 
